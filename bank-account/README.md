...
<details>
<summary style="font-size: 20px">Sujet</summary>
...
<details>
<summary style="font-size: 20px">Lancer le projet</summary>
...
>Accéder au projet : http://localhost:9080/api/v1/swagger-ui/index.html
> Accéder à la BD : http://localhost:9080/api/v1/h2-ui <br>
> <u>host</u>: jdbc:h2:mem:banking | <u>username</u>: banking | <u>password</ul>: banking
